    ...
    <template slot="content">
      <a-spin :spinning="loading">
        <a-tabs class="header-notice-content" :tabBarGutter="25">
          <a-tab-pane key="1">
            <span slot="tab"
              >消息<span v-if="total && totalSum['message']"
                >({{ totalSum["message"] }})</span
              ></span
            >
            ...
            <template v-else>
              <div class="notFound">
                <img
                  src="../../../assets/image/notify/laba.svg"
                  alt="not found"
                />
                <div>你已读完所有消息</div>
              </div>
          ...
          <a-tab-pane key="2">
            <span slot="tab"
              >通知<span v-if="total && totalSum['notice']"
                >({{ totalSum["notice"] }})</span
              ></span
            >
            ...
            <template v-else>
              <div class="notFound">
                <img
                  src="../../../assets/image/notify/bell.svg"
                  alt="not found"
                />
                <div>你已查看所有通知</div>
              </div>
