      ...
      <div class="config-content task-config">
        <div class="content-item">
          <div class="infos">
            ...
            <a-radio-group
              @change="saveProject"
              v-model="project.task_board_theme"
            >
              <a-radio
              ...
              <div class="workflow-content">
                <template v-if="!loadingWorkflowRule">
                  <div class="workflow-rule-item">
                    ...
                    <a-input
                      size="large"
                      v-model="currentTaskWorkflowRule.taskWorkflowName"
                    ></a-input>
                  </div>
                  <div class="workflow-rule-item">
                    <p>选择任务列表</p>
                  ...
                  <template v-if="currentTaskWorkflowRule.firstObj">
                    <div class="workflow-rule-item">
                      ...
                      <a-select
                        ...
                        @change="
                          (value) =>
                            workflowRuleChange(value, 'firstAction.action')
                        "
                      >
                        <a-select-option
                    ...
                    <template
                      v-if="currentTaskWorkflowRule.firstAction.action != -1"
                    >
                      <template
                        v-if="currentTaskWorkflowRule.firstAction.action == 3"
                      >
                        <div class="workflow-rule-item">
                          <p>选择执行者</p>
                          <a-select
                            ...
                            @change="
                              (value) =>
                                workflowRuleChange(value, 'firstAction.value')
                            "
                          >
                            <a-select-option
                      ...
                      <div class="workflow-rule-item">
                        ...
                        <a-select
                          ...
                          @change="
                            (value) =>
                              workflowRuleChange(value, 'firstResult.action')
                          "
                        >
                          <a-select-option
                      ...
                      <template
                        v-if="currentTaskWorkflowRule.firstResult.action === 0"
                      >
                        <div class="workflow-rule-item">
                          <p>流转任务列表</p>
                          <a-select
                            ...
                            @change="
                              (value) =>
                                workflowRuleChange(value, 'firstResult.value')
                            "
                          >
                            <a-select-option
                              v-for="(taskStage, index) in taskStages"
                        ...
                        <template
                          v-if="currentTaskWorkflowRule.firstResult.value"
                        >
                          <div class="workflow-rule-item">
                            <p>选择执行者</p>
                            <a-select
                              ...
                              @change="
                                (value) =>
                                  workflowRuleChange(value, 'lastResult.value')
                              "
                            >
                              <a-select-option
                                v-for="(member, index) in projectMembers"
                        ...
                        <template>
                          <div class="workflow-rule-item">
                            ...
                            <a-select
                              ...
                              @change="
                                (value) =>
                                  workflowRuleChange(value, 'state.value')
                              "
                            >
                              <a-select-option
                      ...
                      <template
                        v-if="currentTaskWorkflowRule.firstResult.action === 3"
                      >
                        <div class="workflow-rule-item">
                          <p>选择执行者</p>
                          <a-select
